...
// Redirect to the selected cinema's official website
Route::get('/cinemas/{cinema}/visit', [CinemaController::class, 'visit'])
    ->name('cinemas.visit');

// Cinema-specific Popcorn Pass Home
Route::get('/cinemas/{cinema}/home', [HomeController::class, 'cinemaHome'])
    ->name('cinemas.home');

// Cinema Profile / Reviews
...
// Movies
// ===========================
Route::get('/movie/{movie}/release', [HomeController::class, 'release'])
    ->name('release');
...
Route::get('/information/{id}', [HomeController::class, 'informationDetail'])
...
// Create PayPal Order
Route::post('/paypal/orders', [ReservationController::class, 'createPayPalOrder'])
    ->name('paypal.orders.create');

// Capture PayPal Order
Route::post('/paypal/orders/capture', [ReservationController::class, 'capturePayPalOrder'])
...
Route::get('/movies/{movieId}/reviews/create', [ReviewController::class, 'create'])
    ->name('reviews.create')
    ->middleware('auth');
...
Route::get('/movies/{movieId}/reviews/{reviewId}/edit', [ReviewController::class, 'edit'])
    ->name('reviews.edit')
    ->middleware('auth');
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::patch('/movies/{movie}/archive', [AdminController::class, 'archive'])
            ->name('movies.archive');
        ...
        Route::post('/coupons/{coupon}/distribute', [AdminController::class, 'distributeCoupon'])
            ->name('coupons.distribute');
        ...
        // Customer Chat (Admin)
        Route::get('/chat', [AdminController::class, 'chat_index'])
            ->name('chat.index');

        Route::get('/chat/{conversation}', [AdminController::class, 'chat_show'])
            ->name('chat.show');

        Route::post('/chat/{conversation}', [AdminController::class, 'chat_store'])
            ->name('chat.store');

        Route::get('/chat/{conversation}/fetch', [AdminController::class, 'chat_fetch'])
            ->name('chat.fetch');

        Route::post('/chat/{conversation}/close', [AdminController::class, 'chat_close'])
            ->name('chat.close');
    });
