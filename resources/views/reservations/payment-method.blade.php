...
@section('content')
    ...
    <div class="reservation-page">
            ...
            <div class="col-lg-7">
                <div class="payment-panel">
                    ...
                    <div class="payment-options">
                        ...
                        <button class="payment-btn {{ ($paymentInfo['method'] ?? '') === 'onsite' ? 'active' : '' }}"
                            data-method="onsite">
                            Pay On-Site
                        </button>
                    ...
                    <div id="payment-form-container" class="mt-4">
                        ...
                        <div id="card-form"
                            class="payment-form {{ ($paymentInfo['method'] ?? 'card') !== 'card' ? 'd-none' : '' }}">
                        ...
                        <div id="paypal-form"
                            class="payment-form {{ ($paymentInfo['method'] ?? '') !== 'paypal' ? 'd-none' : '' }}">
                            <input type="email" placeholder="Paypal Email" class="form-control"
                                value="{{ $paymentInfo['email'] ?? '' }}">
                        </div>

                        <div id="onsite-form"
                            class="payment-form {{ ($paymentInfo['method'] ?? '') !== 'onsite' ? 'd-none' : '' }}">
                            <div class="alert alert-light mb-0">
                                <i class="fa-solid fa-triangle-exclamation"></i> You will pay at the cinema on the day of
                                your visit.
                            </div>
                        </div>
        ...
        <div class="d-flex justify-content-between mt-5">
            ...
            <button id="next-btn" class="next-btn me-5" >
