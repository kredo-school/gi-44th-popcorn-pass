                                                ...
                                                <div class="top-card {{ $size['class'] }}">
                                                    ...
                                                    <div class="movie-info-box">
                                                        ...
                                                        <a href="{{ route('reservations.showtime.selection', ['movie' => $movie->id]) }}"
                                                            ...
                                                            <span class="ranking-book-btn mt-2 w-100 d-block text-center">
                                                                BOOK NOW
                                                            </span>
                                                        </a>
                                                    </div>
                    ...
                    <div class="side-ranking ranking-side-background mt-1">
                        @foreach ($topMovies->slice(3, 7)->values() as $index => $movie)
                            <a href="{{ route('movie_detail', ['movie' => $movie->id]) }}" class="ranking-list-item">
                                ...
                                <img src="{{ $movie->poster_url }}" class="ranking-thumb" alt="{{ $movie->title }}">
                            ...
                            <div class="d-flex gap-4 pb-2 mt-5 ms-4 me-5 coming-soon-track" id="comingSoonSlider">
                                ...
                                @foreach ($comingSoonMovies as $movie)
                                    ...
                                    @php
                                        ...
                                        @endphp <div
                                            class="justify-content-center align-items-end gx-5">
                                                    ...
                                                    <div class="panel-navy-overlay py-4 px-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                ...
                                                                <div
                                                                    class="row justify-content-center align-items-end gx-3">
                                                                    @foreach ($order as $rankIndex)
                                                                        @if (isset($topMovies[$rankIndex]))
                                                                            @php
                                                                                $movie = $topMovies[$rankIndex];
                                                                            ...
                                                                            <div class="col-4">
                                                                                <div class="ranking-card-wrapper">
                                                                                    ...
                                                                                    <div
                                                                                        class="rank-number rank-{{ $rankIndex + 1 }}">
                                                                                        {{ $rankIndex + 1 }}
                                                                                    </div>

                                                                                    <div
                                                                                        class="top-card {{ $s['class'] }}">
                                                                                        ...
                                                                                        <div class="movie-info-box">
                                                                                            ...
                                                                                            <a
                                                                                                ...
                                                                                                <button
                                                                                                    class="ranking-book-btn mt-2 w-100">
                                                                                                    BOOK NOW
                                                                                                </button>
                                                                                            </a>
                                                        ...
                                                        <div class="w-100 py-4 panel-navy-overlay">
                                                            ...
                                                            <div class="d-flex justify-content-end px-4 mb-3 ">
                                                                <a href="{{ route('movie.showtime.display') }}"
                                                                    class="view-all fs-5">View All
                                                                    Showtimes</a>
                                                            </div>

                                                            <div
                                                                class="d-flex align-items-center px-3 m-3 gap-2 position-relative">

                                                                <!-- left button slider-->

                                                                <button id="nowShowingNextBtn" type="button"
                                                                    class="nowshowing-btn">
                                                                    <i class="fa-solid fa-chevron-right"></i>
                                                                </button>

                                                                <!-- Movie Cards scroll -->
                                                                <div class="flex-grow-1 now-showing-track-wrap">
                                                                    <div class="d-flex gap-3 pb-2 now-showing-track"
                                                                        id="nowShowingSlider">
                                                                            ...
                                                                            <div class="now-showing-slide">
                                                                                <div class="movie-card">
                                                                                    ...
                                                                                    <div class="movie-info"
                                                                                        ...
                                                                                        <h6
                                                                                            class="text-white text-center mb-2 mt-2">
                                                                                            {{ $movie->title }}
                                                                                        </h6>
                                                                                        <div class="movie-meta">
                                                                                            <span class="movie-rating">
                                                                                        ...
                                                                                        <a href="{{ route('reservations.showtime.selection', ['movie' => $movie->id]) }}"
                                                                                            class="text-decoration-none">
                                                                                            <button
                                                                                                class="book-btn mt-2 w-100">BOOK
                                                                                                NOW</button>
                                                                                        </a>
                                                                        ...
                                                                        <!-- right button slider-->
                                                                            <button id="nowShowingPrevBtn" type="button"
                                                                                class="nowshowing-btn">
                                                                                <i class="fa-solid fa-chevron-left"></i>
                                                                            </button>
                                                            ...
                                                            <div class="container-fluid px-0 section-gap" id="Comingsoon">
                                                                ...
                                                                <div class="panel-navy-overlay">
                                                                    ...
                                                                    <div class="position-relative px-3 pt-3">
                                                                        ...
                                                                        <!-- Prev button -->
                                                                        <button id="comingSoonPrevBtn" type="button"
                                                                            class="comingsoon-btn">
                                                                            <i class="fa-solid fa-chevron-left"></i>
                                                                        </button>

                                                                        <!-- Next button -->
                                                                        <button id="comingSoonNextBtn" type="button"
                                                                            class="comingsoon-btn">
                                                                            <i class="fa-solid fa-chevron-right"></i>
                                                                        </button>
                                                                    </div>
                                                    ...
                                                    <div class="row" id="Information">
                                                        ...
                                                        <div class="col-10 ">
                                                            ...
                                                            color: {{ $info->category->text_color }};">
                                                                    ...
                                                                    @empty
                                                                        <p class="text-white text-center">No information
                                                                            available.</p>
                                                                    @endforelse
                                                                ...
                                                                <div class="text-center mt-4">
                                                                    <a href="{{ route('information.index') }}"
                                                                        class="btn btn-outline-warning px-5 py-2">
