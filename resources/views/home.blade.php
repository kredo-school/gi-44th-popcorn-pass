                                            ...
                                            <div class="col-10">
                                                ...
                                                <div class="w-100 py-4 panel-navy-overlay">
                                                    ...
                                                    <div class="d-flex align-items-center px-3 m-3 gap-2">
                                                        ...
                                                        <!-- left button slider-->
                                                        <button id="nowPlayingPrevBtn" type="button"
                                                        ...
                                                        <div class="flex-grow-1 now-playing-track-wrap">
                                                            <div class="d-flex gap-3 pb-2 now-playing-track"
                                                                id="nowPlayingSlider">
                                                                    ...
                                                                    <div class="now-playing-slide">
                                                                        <div class="movie-card">
                                                                            ...
                                                                            <div class="movie-info"
                                                                                ...
                                                                                <div
                                                                                    class="movie-meta text-white small px-2">
                                                                                    <div
                                                                                        class="d-flex justify-content-between align-items-center">
                                                                                        <span
                                                                                            class="text-white-50">Adventure</span>
                                                                                        <span>{{ $movie->duration }}</span>
                                                                                    </div>
                                                                                    <div
                                                                                        class="d-flex justify-content-between align-items-center">
                                                                                        <span
                                                                                            class="text-white-50 genre-label">Genre</span>
                                                        ...
                                                        <!-- right button slider-->
                                                        <button id="nowPlayingNextBtn" type="button"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="container-fluid px-0 mt-5 section-gap " id="Food&drink">
                                            ...
                                            <div class="w-75 mx-auto panel-navy-overlay">
                                                <img src="{{ asset('images/foodmenu.png') }}" alt="foodmenu"
                                                    class="w-100 food-menu-img">
                                            </div>
