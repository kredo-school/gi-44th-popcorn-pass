...
@section('content')
    <div
        ...
        style="background-image: url('{{ asset('images/layouts/background.png') }}');"
    >
            ...
            <div class="mt-5 row text-white justify-content-center">
                <div class="col-12 col-md-5 text-center text-md-end mb-4 mb-md-0">
                    <img
                        ...
                        alt="{{ $movie->title }}"
                        class="release-img"
                        onerror="this.onerror=null; this.src='{{ asset('images/no-poster.png') }}';"
                    >
                </div>
                ...
                <div class="col-12 col-md-5 blue-background">
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-8">
                            <a
                                href="{{ route('reviews.index', ['movieId' => $movie->id]) }}"
                        ...
                        <div class="col-8">
                            @php
                                $castMembers = json_decode($movie->cast, true);
